                        ...
                        <div class="tab-pane fade show active" role="tabpanel" id="tab-1">
                            <section class="py-4 py-xl-5">
                                <div class="container bg-black">
                                    <div class="border rounded border-0 d-flex flex-column justify-content-center align-items-center p-4 py-5" style="background: linear-gradient(rgba(0, 0, 0, 0), #000000), url({{ url($series[0]->series_banner) }}); background-size: auto, cover;">
                                        <div class="row">
                                            <div class="col-md-10 col-xl-7 text-center d-flex d-sm-flex d-md-flex justify-content-center align-items-center mx-auto justify-content-md-start align-items-md-center justify-content-xl-center">
                                                <div>
                                                    <img class="img-fluid" src="{{ url($series[0]->series_logo) }}" width="50%" alt="">
                                                    <p class="mb-4" style="color: rgb(255,255,255);font-family: 'Open Sans', sans-serif;">{{ $series[0]->series_description }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @foreach($products as $product)
                                    <div class="col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3 col-xxl-3 item">
                                        <div class="card border rounded-0 bg-black">
                                            <div class="card-body bg-black text-white" style="padding-top: 16px;">
                                                ...
                                                @if (!empty($product->in_development) && $product->in_development === 1)
                                                    <p class="text-white" style="font-size: 15px;"><strong>In Development!</strong></p>
                                                @else
                                                    <p class="text-white" style="color: rgb(0,0,0);font-family: 'Open Sans', sans-serif;font-size: 12px;">
