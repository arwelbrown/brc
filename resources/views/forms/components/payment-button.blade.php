...
>
    <div x-data="{ state: $wire.$entangle('{{ $getStatePath() }}') }">
        ...
        " x-bind:class="{
                'enabled:opacity-70 enabled:cursor-wait': isUploadingFile
            }" 
        ...
        >
            <svg fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="animate-spin fi-btn-icon h-5 w-5" wire:loading.delay.default="" wire:target="pay">
