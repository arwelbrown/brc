...
<head>
    ...
    <script type="application/ld+json">
        {
            ...
            "@type": "WebSite",
            "name": "BRC",
            "url": "https://theexpansecomics.co.uk/"
        }
    </script>
    ...
    @if ($_ENV['APP_ENVIRONMENT'] === 'local')
        ...
        <!-- Scripts -->
    @else
        <link rel="stylesheet" href="{{ url('build/assets/app-6b9c2ee7.css') }}">
        <!-- Scripts -->
...
<body class="bg-black" style="background: rgb(18,21,24);color: rgb(33, 37, 41);">
    <nav class="navbar navbar-expand-lg sticky-top shadow-lg navigation-clean navbar-light" style="background: rgb(0,0,0);">
        <div class="container-fluid">
            <a class="navbar-brand" href="/" style="color: rgb(255,255,255);font-family: Lato, sans-serif;font-size: 22px;font-weight: bold;">
                BROKEN REALITY COMICS
            </a>
            <button data-bs-toggle="collapse" class="navbar-toggler text-start" data-bs-target="#navcol-2" style="border-color: rgb(0,0,0);">
                <span class="visually-hidden">Toggle navigation</span>
                <span class="navbar-toggler-icon" style="color: rgb(255,255,255);border-color: rgb(255,255,255);background: rgba(33,37,41,0);text-align: left;">
