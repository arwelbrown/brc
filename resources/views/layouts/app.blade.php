...
<body class="bg-black" style="background: rgb(18,21,24);color: rgb(33, 37, 41);">
    <nav class="navbar navbar-expand-lg sticky-top shadow-lg navigation-clean navbar-light"
        ...
        <div class="container-fluid">
            ...
            <button data-bs-toggle="collapse" class="navbar-toggler text-start" data-bs-target="#navcol-2"
            ...
            <div class="collapse navbar-collapse" id="navcol-2">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item text-end"><a class="nav-link hover" href="/store"
                            style="color: var(--bs-white);font-size: 18px;font-family: 'Open Sans', sans-serif;">Comic
                            Book Store</a></li>
                    <li class="nav-item text-end"><a class="nav-link"
                            href="https://www.redbubble.com/people/BRCStore/shop"
                            style="color: var(--bs-white);font-size: 18px;font-family: 'Open Sans', sans-serif;">Merch
                            Store</a></li>
                    <li class="nav-item text-end"></li>
                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link text-end" aria-expanded="false"
                            data-bs-toggle="dropdown" href="#"
                            style="font-size: 18px;font-family: 'Open Sans', sans-serif;color: rgb(255,255,255);">More!</a>
                        <div class="dropdown-menu text-end" style="font-size: 13px;background: rgb(0,0,0);">
                            <a class="dropdown-item text-white" href="/about-us"
                    ...
                    <li class="nav-item text-end">
                        <a class="nav-link ec_ejc_thkbx "
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                fill="currentColor" viewBox="0 0 16 16" class="bi bi-cart-fill">
                                <path
    ...
    <div class="container">
        <div class="row g-0 text-center justify-content-center align-items-center">
            <div class="col-4 col-sm-3 col-md-3 col-lg-2 col-xl-2 align-self-center item">
                <div>
                    <a href="/">
                        <img class="img-fluid" src="{{ url('img/br_admin/hexa_final_1.webp') }}" width=""
                            alt="BRC Hex logo">
                    </a>
                </div>
            </div>
            <div class="col-5 col-sm-5 col-md-3 col-lg-3 col-xl-3 col-xxl-2 offset-md-1 offset-lg-1 offset-xl-1 align-self-center item"
                ...
                <ul class="list-unstyled text-center text-white">
                    <li class="text-center" style="font-size: 16px;">
                        <div><a href="/store" style="font-family: 'Open Sans', sans-serif;">Comic Book Store</a>
                        </div>
                    </li>
                    <li class="text-center" style="font-size: 16px;">
            ...
            <div class="col-lg-2 col-xl-2 offset-lg-1 offset-xl-0 align-self-center item social">
                ...
                <a
                    href="https://www.kickstarter.com/projects/legends-tableflip/the-expanse-1?ref=6fu64q&amp;token=fc2d1ba9">
