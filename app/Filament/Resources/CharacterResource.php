            ...
            Section::make("Character Info")
                ->schema([
                    ...
                    Select::make("series_id")
                        ...
                        ->required(),
                    TextInput::make("real_name")->placeholder("Enter here..."),
                    TextInput::make("race")
                        ->required()
                    ...
                    Select::make("appearances")
                        ...
                        ->getSearchResultsUsing(
                            fn(string $search): array => Series::where(
                                "series_name",
                                "like",
                                "%{$search}%",
                            )
                                ->limit(50)
                                ->pluck("series_name", "id")
                                ->toArray(),
                        )
                        ->getOptionLabelsUsing(
                            fn(array $values): array => Series::whereIn(
                                "id",
                                $values,
                            )
                                ->pluck("series_name", "id")
                        ...
                        ->preload(),
                    Textarea::make("history")->columnspan(2),
                ])
                ->columns(2),
            Section::make("Character Images")->schema([
